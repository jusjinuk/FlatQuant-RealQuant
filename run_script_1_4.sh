...
rm -rf ./outputs/ddp_${NUM_DDP_SIZE}_flat${QAT_FILE}_bsz1_accum4
touch ./outputs/

torchrun --nproc_per_node=$NUM_PROC --master_port 29501 main.py \
  	...
  	--cali_bsz 1 --cali_bsz_accumulate_step 4 --epoch 15 --flat_lr 5e-3 \
        --lwc --lac --cali_trans --add_diag $QAT_FLAG \
        --output_dir ./outputs/ddp_${NUM_DDP_SIZE}_flat${QAT_FILE}_bsz1_accum4 --save_matrix \
        --quantized_save \
