...
torchrun --nproc_per_node=$NUM_PROC --master_port 29504 main.py \
  	...
  	--cali_bsz 1 --cali_bsz_accumulate_step 4 --epoch $EPOCH --flat_lr 5e-3 \
        --lwc --lac --cali_trans --add_diag $QAT_FLAG \
        --output_dir ./outputs/ddp_${NUM_DDP_SIZE}_flat${QAT_FILE}_bsz1_accum4_epoch${EPOCH}_nsamples${NSAMPLES} \
        --quantized_save \
