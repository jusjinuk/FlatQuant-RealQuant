...
def benchmark(args):
    final_results_fp16 = {}
    final_results_flat = {}
    configs = [args.model_config] if args.model_config else model_configs
    for config_name in configs:
        ...
        for online_trans in online_trans_list:
            ...
            weight_dir = args.checkpoint if args.checkpoint else os.path.join(".", "outputs", model_name, "w4a4", "exp")
